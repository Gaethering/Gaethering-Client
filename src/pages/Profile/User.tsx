...
function User() {
  ...
  const [petList, setPetList] = useState([
    ...
    },
    {
      name: '해삐',
      isDelegate: false,
      imageUrl: 'https://images.pexels.com/photos/13215915/pexels-photo-13215915.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500'
    },
    
  ]);
  return (
    <StyledUser>
      <UserProfile userName="user1234" userLocal="ㅂㅂ동" userTemp={36.5} petImg={petList[0].imageUrl}/>
